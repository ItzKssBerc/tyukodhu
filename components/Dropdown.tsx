...
export default function Dropdown({
    ...
    return (
        ...
        >
            ...
            {isOpen && (
                <ul
                    className="absolute z-50 w-full mt-2 bg-white/80 dark:bg-stone-950/80 backdrop-blur-xl border border-stone-200 dark:border-stone-800 rounded-2xl shadow-xl max-h-60 overflow-auto focus:outline-none animate-in fade-in slide-in-from-top-2 duration-200"
                    role="listbox"
                >
