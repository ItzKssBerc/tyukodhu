...
import '@changey/react-leaflet-markercluster/dist/styles.min.css'; // Import cluster styles from the new package
import { LatLngExpression, LatLngBoundsExpression } from 'leaflet';
import { useEffect, useState } from 'react';
import L from 'leaflet';
import MarkerClusterGroup from '@changey/react-leaflet-markercluster'; // Import the cluster group from the new package
